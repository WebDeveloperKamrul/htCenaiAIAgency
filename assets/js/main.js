...
27. Custom Countdown 
=========================== */
/* ===== CONFIG DATE (CHANGE ONLY THIS) ===== */
const targetDate = new Date("2026-02-31T23:59:59").getTime();
...
function updateCountdown(){
  ...
  const map = {
    "days-tens": Math.floor(days / 10),
    "days-ones": days % 10,
    "hours-tens": Math.floor(hours / 10),
    "hours-ones": hours % 10,
    "minutes-tens": Math.floor(minutes / 10),
    "minutes-ones": minutes % 10,
    "seconds-tens": Math.floor(seconds / 10),
